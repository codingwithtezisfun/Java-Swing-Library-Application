...
public class RegisterStudentLeaseBook {
    ...
    public RegisterStudentLeaseBook() {
        frame = new JFrame("");
...
// Add courses to the combo box
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            RegisterStudentLeaseBook registerStudent= new RegisterStudentLeaseBook();
        });
    }
}
